...
// gsap(요소, 지속시간, 옵션) 애니메이션을 처리해 주는 라이브러리
...
new Swiper('.promotion .swiper', {
  ...
  slidesPerView: 3,     // 한 번에 보열줄 슬라이드 개수
...
const probotionToggleBtn = document.querySelector('.toggle-promotion')
let isHidePromotion = false;

probotionToggleBtn.addEventListener('click', function() {
